<header>            
    <nav>
        <div class="nav-wrapper black lighten-1">
            ...
            <img src="/Servicios/img/img.png" class="brand-logo">
            <div class="container">
                ...
                <ul class="right hide-on-med-and-down"> 
                    ...
                    <li class="menu-servicios">                        
                        ...
                        <ul id="dropdown-servicios" class="dropdown-content">
                            <li><a href="/MotelsLineV/admin/servicios/registrar.jsp"><i class="fa fa-plus"></i> Registrar</a></li>
                            <li><a href="/MotelsLineV/admin/"><i class="fa fa-list"></i> Listar</a></li>                            
                            <li><a href="/MotelsLineV/admin/servicios/eliminar.jsp"><i class="fa fa-trash-o "></i> Eliminar</a></li>
                            <li><a href="/MotelsLineV/admin/servicios/eliminart.jsp"><i class="fa fa-pencil-square-o"></i> Modificar y <i class="fa fa-trash-o "></i> Eliminar</a></li>
                            <li><a href="/MotelsLineV/reporte.jsp" target="_blank"><i class="fa fa-file-pdf-o" ></i> Reporte</a></li>
                        </ul>
                    </li>
                    <!-- Reservas-->
                    ...
                    <li class="menu-empleados">
                        ...
                        <ul id="dropdown-empleados" class="dropdown-content">
                            <li><a href="/MotelsLineV/admin/empleados/registrar.jsp"><i class="fa fa-plus"></i> Registrar</a></li>
                            <li><a href="/MotelsLineV/admin/index.jsp"><i class="fa fa-list"></i> Listar</a></li>
                            <li><a href="/MotelsLineV/admin/empleados/modificar.jsp"><i class="fa fa-pencil-square-o"></i> Modificar</a></li>
                            <li><a href="/MotelsLineV/admin/empleados/eliminar.jsp"><i class="fa fa-trash-o "></i> Eliminar</a></li>
                            <li><a href="/MotelsLineV/admin/empleados/reporte.jsp" target="_blank"><i class="fa fa-file-pdf-o" ></i> Reporte</a></li>
                        </ul>
                    </li>
                    <li><a href="/MotelsLineV/LogoutServlet"><i class="fa fa-sign-out "></i> Salir</a></li>
                </ul>
                ...
                <ul id="mobile-demo" class="side-nav">
                    ...
                    <li class="menu-servicios">
                        ...
                        <ul id="dropdown-servicios-mobile" class="dropdown-content">
                            <li><a href="/MotelsLineV/admin/servicios/registrar.jsp"><i class="fa fa-plus"></i> Registrar</a></li>
                            <li><a href="/MotelsLineV/admin/index.jsp"><i class="fa fa-list"></i> Listar</a></li>
                            <li><a href="/MotelsLineV/admin/servicios/modificar.jsp"><i class="fa fa-pencil-square-o"></i> Modificar</a></li>
                            <li><a href="/MotelsLineV/admin/servicios/eliminar.jsp"><i class="fa fa-trash-o "></i> Eliminar</a></li>
                            <li><a href="/MotelsLineV/admin/servicios/eliminart.jsp"><i class="fa fa-pencil-square-o"></i> Modificar y <i class="fa fa-trash-o "></i> Eliminar</a></li>
                            <li><a href="/MotelsLineV/admin/servicios/reporte.jsp" target="_blank"><i class="fa fa-file-pdf-o" ></i> Reporte</a></li>
                        </ul>
                    </li>
                    <!-- Reservas-->
                    <li class="menu-reservas"><a href="#"><i class="fa fa-bell"></i> Reservas</a></li> 
