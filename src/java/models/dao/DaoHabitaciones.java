...
public class DaoHabitaciones {
    public int insertar(Habitaciones habitacion){
        ...
        try{            
            PreparedStatement statement = conexion.prepareStatement("INSERT INTO habitaciones(nombre, cantidad, descripcion, precio, cantidad_horas, hora_adicional, persona_adicional) values (?, ?, ?, ?, ?, ?, ?)");
            if(statement == null){
                return 0;
            }
